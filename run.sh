...
chmod a+x ./src/analytics/*.java
javac ./src/analytics/*.java
java -cp ./src analytics.FansiteAnalytics ./log_input/log.txt ./log_output/hosts.txt ./log_output/resources.txt ./log_output/hours.txt ./log_output/blocked.txt
